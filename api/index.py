...
@api_bp.route("/player/<int:player_id>")
...
@api_bp.route("/standings/<int:league_id>")
...
@api_bp.route("/match/<int:match_id>/player/<int:player_id>/heatmap")
...
# No app.run() here; Vercel will import the 'app' object.
